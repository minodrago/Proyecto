...
$("#pulsar").click(function(e) {
 ...
 $("#externo").attr("src","../subir/doc_creador_c.php");
...
$("#pulsar500").click(function(e) {
 ...
 $("#externo").attr("src","../subir/listac500.php");
...
$("#pulsar100500").click(function(e) {
 ...
 $("#externo").attr("src","../subir/listac100500.php");
...
$("#pulsar100").click(function(e) {
 ...
 $("#externo").attr("src","../subir/listac100.php");
...
<ol class="tree">
		...
		<li>
			<label for="folder3">Cotizaciones</label> <input type="checkbox" id="folder3" /> 
			<ol>
				<li class="file"><a href="" id="pulsar2">Agregar nuevo</a></li>
                <li class="file"><a href="" id="pulsar">Mis documentos subidos</a></li>
