...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Listado Cotizaciones Inferiores a 500 Millones y superiores a 100 Millones</title>
    </head>
<style>
* body {
	background:url();
    ...
    <body>
       <form>
            ...
            <tr>
                ...
                <th width="500">Valor</th>
                <th width="200">Fcha Creacion</th>
                <th width="200">Responsable</th>
                <th width="112">Estatus</th>
                <th width="150">Probabilidad</th>
                <th width="150">Zona</th>
                <th width="200">Ultimo Seguimiento</th>
                <th width="200">Proximo Seguimiento</th>
                <th width="200">Cierre</th>
                <th width="250">Archivo</th>
                <th width="500">Comentarios</th>
        ...
        $db=new Conect_MySql();
           // $sql = "select*from tbl_cotizacion ORDER BY fecha_crea DESC";
            ...
            $sql = "SELECT id_cotizacion, tbl_cliente.nombre_cliente, tbl_linea.nombre_linea, valor, fecha_crea, tbl_responsable.nombre_responsable, tbl_estatus.nombre_estatus, probabilidad, tbl_zona.nombre_zona, ultseg_fecha, proxseg_fecha, cierre_fecha,archivo,comentarios FROM tbl_cotizacion INNER JOIN tbl_cliente ON tbl_cotizacion.id_cliente = tbl_cliente.id_cliente INNER JOIN tbl_responsable ON tbl_cotizacion.id_responsable = tbl_responsable.id_responsable INNER JOIN tbl_estatus ON tbl_cotizacion.id_estatus = tbl_estatus.id_estatus INNER JOIN tbl_zona ON tbl_cotizacion.id_zona = tbl_zona.id_zona INNER JOIN tbl_linea ON tbl_cotizacion.id_linea = tbl_linea.id_linea  WHERE valor < '500000000' AND valor >= '100000000'  order by fecha_crea desc;";
