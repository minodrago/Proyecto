  ...
  <tbody>
        ...
        $db=new Conect_MySql();
			...
			<tr>
				...
				<td align="center" valign="middle"><pre>$<?php echo number_format ($datos ['valor']); ?></pre></td>
				<td align="center" valign="middle"><?php echo date("d-m-Y", strtotime($datos["fecha_crea"])); ?></td>
				<td align="center" valign="middle"><?php echo $datos['nobre_responsable']; ?></td>
				...
				<td align="center" valign="middle"><font size="1px"><?php echo $datos['comentarios']; ?></td>
               	<td><a  class="myButton" title="Aquí para nuevas modificaciones" href="editar_r.php?id=<?php echo $datos['id_cotizacion']?>">Aquí para nuevas modificaciones</a>
              </tr>
		</tbody>
